...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($koneksi, "INSERT INTO spm_berjalan SET 
        tahun='$tahun_input',
...
<head>
    <meta charset="UTF-8">
    <title>Tambah SPM Berjalan</title>
        ...
        <div class="card shadow" style="width: 40rem;">
            ...
            <div class="card-body">
                ...
                <form method="post">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Jumlah Belanja</label>
                        <input type="number" step="0.01" name="jumlah_belanja" class="form-control" required>
                    </div>
