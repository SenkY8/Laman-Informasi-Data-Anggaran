...
$query = mysqli_query($koneksi, "SELECT * FROM komparasi_nilai_kinerja WHERE id=$id");
...
if(isset($_POST['simpan'])) {
    ...
    $sql = "UPDATE komparasi_nilai_kinerja SET capaian=$capaian WHERE id=$id";
...
<head>
    ...
    <title>Edit Data Nilai Kinerja</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content" class="p-4">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-edit text-primary"></i> Edit Data Nilai Kinerja</h1>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary text-white">
                    <h6 class="m-0 font-weight-bold"><i class="fas fa-file-alt"></i> Form Edit Data</h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" value="<?= $data['tahun_anggaran'] ?>" disabled>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Capaian (%)</label>
                                <input type="number" name="capaian" class="form-control" step="0.01" value="<?= $data['capaian'] ?>" required>
                            </div>
                        </div>
