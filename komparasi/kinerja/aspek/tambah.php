...
if(isset($_POST['simpan'])) {
    ...
    if (!$aspek) {
        ...
        $cek = mysqli_query($koneksi, "SELECT id FROM kinerja_aspek WHERE aspek = '$aspek_sql' AND tahun_anggaran = $tahun_anggaran");

        if (mysqli_num_rows($cek) > 0) {
            $error = "Data aspek '$aspek' tahun $tahun_anggaran sudah ada!";
        } else {
            $sql = "INSERT INTO kinerja_aspek (aspek, tahun_anggaran, nilai) VALUES ('$aspek_sql', $tahun_anggaran, $nilai)";
...
$daftar_aspek = [];
$qa = mysqli_query($koneksi, "SELECT DISTINCT aspek FROM kinerja_aspek ORDER BY aspek ASC");
