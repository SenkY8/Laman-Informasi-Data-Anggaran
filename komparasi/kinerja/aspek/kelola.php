...
$daftar_aspek = [];
$qa = mysqli_query($koneksi, "SELECT aspek FROM kinerja_aspek GROUP BY aspek ORDER BY MIN(id) ASC");
while($r = mysqli_fetch_assoc($qa)) $daftar_aspek[] = $r['aspek'];

// Ambil semua data
$data = [];
$q = mysqli_query($koneksi, "SELECT a.* FROM kinerja_aspek a JOIN (SELECT aspek, MIN(id) as min_id FROM kinerja_aspek GROUP BY aspek) b ON a.aspek = b.aspek ORDER BY b.min_id ASC, a.tahun_anggaran ASC");
...
<head>
    ...
    <title>Kelola Data Nilai Kinerja</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content" class="p-4">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-folder-open"></i> Kelola Data Nilai Kinerja</h1>
