...
$result = mysqli_query($koneksi, "SELECT * FROM kinerja_aspek WHERE id = $id");
...
if(isset($_POST['simpan'])) {
    ...
    if (!$aspek) {
        ...
        $cek = mysqli_query($koneksi, "SELECT id FROM kinerja_aspek WHERE aspek = '$aspek_sql' AND tahun_anggaran = $tahun_anggaran AND id != $id");
        if (mysqli_num_rows($cek) > 0) {
            $error = "Data aspek '$aspek' tahun $tahun_anggaran sudah ada!";
        } else {
            $sql = "UPDATE kinerja_aspek SET aspek = '$aspek_sql', tahun_anggaran = $tahun_anggaran, nilai = $nilai WHERE id = $id";
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content" class="p-4">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-edit text-info"></i> Edit Data Nilai Kinerja</h1>
