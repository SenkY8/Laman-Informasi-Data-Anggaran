...
if(isset($_POST['simpan'])) {
    ...
    $sql = "INSERT INTO komparasi_nilai_kinerja (tahun_anggaran, capaian)
            VALUES ($tahun, $capaian)";
...
<head>
    ...
    <title>Tambah Data Nilai Kinerja</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content" class="p-4">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-plus text-success"></i> Tambah Data Nilai Kinerja</h1>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-success text-white">
                    <h6 class="m-0 font-weight-bold"><i class="fas fa-file-alt"></i> Form Tambah Data</h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="tahun" class="form-control" value="<?= $current_year ?>" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label>Capaian (%)</label>
                                <input type="number" name="capaian" class="form-control" step="0.01" value="0" required>
                            </div>
                        </div>
