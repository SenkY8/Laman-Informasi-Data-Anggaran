...
// Ambil data existing
$query = "SELECT * FROM komparasi_indikator_kinerja WHERE id = $id";
...
if(isset($_POST['simpan'])) {
    ...
    if (!$tahun_anggaran) {
        ...
        $sql = "UPDATE komparasi_indikator_kinerja SET tahun_anggaran = $tahun_anggaran, capaian = $capaian WHERE id = $id";
...
<head>
    ...
    <title>Edit Data Indikator Kinerja</title>
