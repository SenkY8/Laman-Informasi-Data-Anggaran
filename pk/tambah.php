...
if(isset($_POST['simpan'])) {
    ...
    // Fungsi untuk convert koma ke titik
    ...
    $sql = "INSERT INTO pk_2025_kinerja 
            (tahun, jenis, deskripsi, indikator, target, jan, feb, mar, apr, mei, jun, jul, agu, sep, okt, nov, des)
            VALUES 
            ('$tahun_input', '$jenis', '$deskripsi', '$indikator', '$target', $jan, $feb, $mar, $apr, $mei, $jun, $jul, $agu, $sep, $okt, $nov, $des)";
    
    if(mysqli_query($koneksi, $sql)) {
        header("Location: index.php?tahun=$tahun_input&pesan=tambah");
        exit;
    } else {
...
<head>
    ...
    <title>Tambah Data Perjanjian Kinerja</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content" class="p-4">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-plus text-success"></i> Tambah Data Perjanjian Kinerja</h1>
                <a href="index.php?tahun=<?= $tahun ?>" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Kembali</a>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-success text-white">
                    <h6 class="m-0 font-weight-bold"><i class="fas fa-file-alt"></i> Form Tambah Data - Tahun <?= $tahun ?></h6>
                </div>
                <div class="card-body">
                    <form method="POST" action="">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label>Target</label>
                                <input type="text" name="target" class="form-control" placeholder="contoh: 80%, 90, dst" required>
                            </div>
                        </div>

                        <div class="form-group">
                            <label>Deskripsi</label>
                            <textarea name="deskripsi" class="form-control" rows="3" placeholder="Deskripsi lengkap" required></textarea>
                        </div>

                        <div class="form-group">
                            <label>Indikator</label>
                            <textarea name="indikator" class="form-control" rows="3" placeholder="Indikator kinerja" required></textarea>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label>Januari</label>
                                <input type="text" name="jan" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Februari</label>
                                <input type="text" name="feb" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Maret</label>
                                <input type="text" name="mar" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                            <div class="form-group col-md-3">
                                <label>April</label>
                                <input type="text" name="apr" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                <label>Mei</label>
                                <input type="text" name="mei" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Juni</label>
                                <input type="text" name="jun" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Juli</label>
                                <input type="text" name="jul" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Agustus</label>
                                <input type="text" name="agu" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="text" name="sep" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Oktober</label>
                                <input type="text" name="okt" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                            <div class="form-group col-md-3">
                                <label>November</label>
                                <input type="text" name="nov" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Desember</label>
                                <input type="text" name="des" class="form-control decimal-input" placeholder="0,00" pattern="[\d.,]+" inputmode="decimal">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mt-4">
                            <div class="col-sm-12">
                                ...
                                <a href="index.php?tahun=<?= $tahun ?>" class="btn btn-secondary btn-lg">
