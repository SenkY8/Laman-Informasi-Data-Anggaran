...
if (isset($_POST['simpan'])) {
    ...
    mysqli_query($koneksi, "
        INSERT INTO permasalahan_tindak_lanjut (tahun, permasalahan, tindak_lanjut)
        VALUES ('$tahun_input', '$permasalahan', '$tindak_lanjut')
    ");
...
<head>
    <meta charset="UTF-8">
    <title>Tambah Permasalahan & Tindak Lanjut</title>
    ...
    <div class="d-flex justify-content-center">
        <div class="card shadow" style="width: 50rem;">
            <div class="card-header py-3">
                <h5 class="m-0 font-weight">Tambah Permasalahan & Tindak Lanjut - Tahun <?= $tahun ?></h5>
            </div>
            <div class="card-body">
                <form method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="permasalahan" rows="4" class="form-control" required></textarea>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Tindak Lanjut</label>
                        <textarea name="tindak_lanjut" rows="4" class="form-control" required></textarea>
                    </div>
